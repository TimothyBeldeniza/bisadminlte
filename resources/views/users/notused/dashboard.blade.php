                ...
                <div class="card">
                    ...
                    {{-- @role('Resident') --}}
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <button class="btn btn-outline-primary mx-2" data-toggle="collapse" href="#documents" role="button" aria-expanded="false" aria-controls="documents">Requested Documents</button>
                            <button class="btn btn-outline-warning mx-2" data-toggle="collapse" href="#complaints" role="button" aria-expanded="false" aria-controls="complaints">Complaints Filed</button>
                            <button class="btn btn-outline-success mx-2" data-toggle="collapse" href="#blotters" role="button" aria-expanded="false" aria-controls="blotters">Blotters Filed</button>
                            <button class="btn btn-outline-danger mx-2" data-toggle="collapse" href="#xdocuments" role="button" aria-expanded="false" aria-controls="xdocuments">Cancelled Requests</button>
                        </div>
                        <hr>
                        <p><b>Results</b></p>
                        {{-- Collapse Items --}}
