<x-layout>
   ...
   <div class="content-header">
      <div class="container-fluid">
          <div class="row mb-2">
              <div class="col-sm-6">
                  <h1 class="m-0">Record Complaint</h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
   ...
   <div class="content">
      <div class="container">
         <div class="card">
            <div class="card-header font-weight-bold text-light" style="background-color: maroon;">Complaint Form</div>
            <div class="card-body">
               <form method="POST" action="{{ route('complaints.store') }}" enctype="multipart/form-data">
                  @csrf
                  <b>Complainant</b><br>
                  ...
                  <div class="form-group row my-1">
                     <div class="col-sm">
                           <label for="complainantId">{{ __('Complainant Name') }}</label>
                  ...
                  <div id="otherComplainant" style="display: none">
                     ...
                     <div class="form-group row my-1">
                        <div class="col-sm">
                           ...
                           <input id="cName" type="text" class="form-control" name="cName" @error('cName') is-invalid @enderror placeholder="Enter Complainant Full Name..." onfocus="this.value=''">
                           @error('cName')
                              <span class="invalid-feedback" role="alert">
                                 <strong>{{ $message }}</strong>
                              </span>
                        ...
                        <div class="col-sm">
                           ...
                           <textarea class="form-control" @error('cAddress') is-invalid @enderror placeholder="Enter Complainant's Address here..." name="cAddress" id="cAddress" cols="30" rows="3" onfocus="this.value=''"></textarea>
                        </div>
                     </div>
                  ...
                  <div class="form-group row my-1">
                     <div class="col-sm">
                        <label for="respondentId">{{ __('Respondent Name') }}</label>
                        <select id="respondentId" name="respondentId" class="form-control" onfocus="this.value=''">
                           <option value>--Select Registered User--</option>
                        @foreach ($users as $user)
                           <option value="{{ $user->id }}">{{ $user->firstName. ' '. $user->lastName }}</option>
                  ...
                  <div class="form-group row my-1">
                     <div class="col-sm">
                        <label for="respondents">{{ __('Respondent Name') }}</label> 
                        <input id="respondents" type="text" class="form-control" @error('respondents') is-invalid @enderror placeholder="Enter Respondent Full Name here..." name="respondents" onfocus="this.value=''">
                        @error('respondents')
                           <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                     ...
                     <div class="col-sm">
                        <label for="respondentsAdd">{{ __("Respondents Address*") }}</label>
                        <textarea class="form-control" placeholder="Enter Respondent's Address here..." name="respondentsAdd" id="respondentsAdd" cols="30" rows="3" onfocus="this.value=''"></textarea>
                     </div>
                  </div>
                  ...
                  <div class="form-group row my-2">
                     <div class="col-sm">
                        <button onclick="return confirm('Are your inputs correct?')" type="submit" class="btn btn-success font-weight-bold" >
                              {{ __('Submit') }}
                        </button>
                        <button onclick="history.back()" type="submit" class="btn btn-dark font-weight-bold" >
                              {{ __('Back') }}
                        </button>
                     </div>
                  </div>
