...
<body onload="window.print();" onafterprint="window.close();">
        ...
        <div class="footer">
            <br>
            <p>Ginawa ngayong araw, <b>{{ Carbon\Carbon::parse($td->up_date)->format('j F, Y') }}</b> </p> <br>
            <p id="name"><u>{{ $td->complainant }}</u></p>
            <p>Lagda ng Nagrereklamo</p> <br>
            <p>Natanggap at Nagsampa ngayong <b>{{ Carbon\Carbon::parse($td->up_date)->format('j F, Y') }}</b></p> <br>
