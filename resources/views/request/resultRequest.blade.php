            ...
            <div class="card">
              <div style="background-color: maroon;" class="card-header text-light"><b>Profile</b></div>
                  <div class="card-body">
                    ...
                    <p class="text-start card-text"><b>Requestor:</b> {{ $data->lastName . ' ' . $data->firstName}}</p>
                    <p class="text-start card-text"><b>Email:</b> {{ $data->email}}</p>
                  </div>
            </div>
          </div>
          {{-- <div class="col-sm-6">
              ...
              <div class="card">
                <div style="background-color: maroon;" class="card-header text-light"><b>Request Details</b></div>
                    <div class="card-body">
                        ...
                        @endif
                        <button type="button" class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#bargyId{{$data->id}}">Show ID</button>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                          @if($data->status == 'Unpaid')
                              <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#process{{ $data->id }}">Process</a>
                              <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#disapprove{{ $data->id }}">Disapprove</a>
